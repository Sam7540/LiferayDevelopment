...
/**
 * Provides the local service interface for Form1. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see Form1LocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface Form1LocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.safesail.service.impl.Form1LocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the form1 local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link Form1LocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Form1 addReg(
		...
		long phoneNumber, long AnnualIncome, String panNumber, Date dob,
		String gender, Boolean condition, long sumAssured);
